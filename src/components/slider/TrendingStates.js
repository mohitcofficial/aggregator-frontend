...
function TrendingStatesSlider() {
  ...
  const fetchTrendingCityData = async () => {
    setLoading(true);
    try {
      const data = await UserApiServices.getTrendingStates();
      ...
      {loading ? (
        ...
        <div className={classes.innerContainer}>
          <div className={classes.rightBox}>
            <Slider {...sliderSettings} key={states.length}>
...
export default TrendingStatesSlider;
